 ...
 */
final class Version20210315100451 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ligne_entree (id INT AUTO_INCREMENT NOT NULL, article_id INT DEFAULT NULL, entree_id INT DEFAULT NULL, qte_entr INT NOT NULL, qte_reste INT DEFAULT NULL, INDEX IDX_7F59EBE07294869C (article_id), INDEX IDX_7F59EBE0AF7BD910 (entree_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
