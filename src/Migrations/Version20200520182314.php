 ...
 */
final class Version20200520182314 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE stock (id INT AUTO_INCREMENT NOT NULL, produit_id INT NOT NULL, ligne_entree_id INT NOT NULL, date DATE NOT NULL, qte INT NOT NULL, qte_reste INT NOT NULL, INDEX IDX_4B365660F347EFB (produit_id), INDEX IDX_4B365660609ED698 (ligne_entree_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
